...
moduleName="NetworkFramework"

iphoneosArchiveDirectoryPath="/$moduleName-iphoneos.xcarchive"
iphoneosArchiveDirectory="$(pwd)$iphoneosArchiveDirectoryPath"

iphonesimulatorArchiveDirectoryPath="/$moduleName-iphonesimulator.xcarchive"
iphoneosSimulatorDirectory="$(pwd)$iphonesimulatorArchiveDirectoryPath"
